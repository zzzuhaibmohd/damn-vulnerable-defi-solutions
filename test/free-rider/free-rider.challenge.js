...
describe('[Challenge] Free Rider', function () {
    ...
    it('Exploit', async function () {
        ...
        this.attackFreeRider = await ethers.getContractFactory('AttackFreeRider2', attacker);
        this.attackFreeRider.deploy(
